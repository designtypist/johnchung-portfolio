...
<div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
  <header class="container mx-auto px-16">
    <nav class="flex flex-wrap justify-between items-center py-8">
      <div class="uppercase">
      ...
      <ul class="tracking-wide font-bold w-full block flex-grow lg:flex lg:flex-initial lg:w-auto items-center mt-8 lg:mt-0" :class="isOpen ? 'block': 'hidden'">
        ...
        <li class="mr-8 mb-6 lg:mb-0">
          ...
          <g-link to="/animation" class="text-copy-primary">animation</g-link>
        </li>
        <li class="mr-8 mb-6 lg:mb-0">
          <g-link to="/portfolio" class="text-copy-primary">portfolio</g-link>
        </li>
        <li class="mr-8 mb-6 lg:mb-0">
          <g-link to="/sketchbook" class="text-copy-primary">sketchbook</g-link>
        </li>
        <li class="mr-8 mb-6 lg:mb-0">
  ...
  <footer class="container mx-auto px-16">
    <div class="flex flex-col lg:flex-row items-center justify-between py-8">
      <div class="w-full mb-8 lg:mb-0">
        <div class="flex">
          ...
          <div class="flex-initial inline">
            <ul class="flex items-center">
              <li class="mr-8">
                <a href="mailto:me@example.com" class="hover:text-gray-400 text-copy-primary">
              ...
              <li class="mr-8">
                <a href="https://twitter.com/" target="_blank" class="hover:text-gray-400 text-copy-primary">
              ...
              <li>
                <a href="https://instagram.com" target="_blank" class="hover:text-gray-400 text-copy-primary">
        ...
        <div class="copyright">
            <p class="text-copy-primary inline">
              <span>Copyright {{ new Date().getFullYear() }}. All rights reserved.</span>
              <span class="float-right">Developed and designed by 
                <a href="http://designtypist.com/" target="_blank" class="text-copy-primary">James Chung</a>
              </span>
            <p/>
        </div>
      </div>
