  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="container mx-auto lg:py-16 lg:px-8 p-6">
      <nav class="flex flex-wrap justify-between items-center">
        <div class="uppercase">
          ...
          <p class="text-sm">animator • illustrator • character designer</p>
        </div>
    ...
    <footer class="container mx-auto md:px-16 md:py-8 p-4">
      <div class="flex flex-wrap my-2">
        <div class="lg:flex-initial flex-auto lg:pr-4 pr-0">
          <a href="mailto:johnchungart@gmail.com" class="text-xl">
            johnchungart@gmail.com
          </a>
        </div>
        <div class="lg:flex-initial flex-none vertical-line mr-6 text-copy-primary"></div>
        <div class="lg:flex-initial flex-auto">
