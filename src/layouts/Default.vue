    ...
    <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
      ...
      <ul class="tracking-wide font-bold w-full block flex-grow lg:flex lg:flex-initial lg:w-auto items-center mt-8 lg:mt-0" :class="isOpen ? 'block': 'hidden'">
        ...
        <li class="mr-8 mb-6 lg:mb-0">
          ...
          <g-link to="/animation" class="text-copy-primary hover:text-gray-600">animation</g-link>
        </li>
        <li class="mr-8 mb-6 lg:mb-0">
  ...
  <footer>
    <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
      <div class="mb-8 lg:mb-0">
        <div class="text-copy-primary">Copyright {{ new Date().getFullYear() }}. All rights reserved.</div>
      </div>
